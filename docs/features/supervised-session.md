...
- **Phase 3 (MCP + cross-repo docs, shipped 2026-05-27)** — `list_sessions` + `get_session_report` MCP tools in `Canary.McpServer` (total tools 8 → 10). Canary AGENTS.md + README + mcp-server.md updated; MultiVerse BUILD_LOG.md cross-repo entry; Qualia AGENTS.md gains a supervised-session pointer in the Canary integration section.
