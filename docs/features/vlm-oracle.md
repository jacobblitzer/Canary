...
Pick the right mode for the job — see [`MultiVerse/AGENTS-DETAIL.md` § Testing modes](../../../MultiVerse/AGENTS-DETAIL.md#testing-modes--vlm-vs-visual-regression) for the canonical workflow guidance.
